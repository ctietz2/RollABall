...
namespace Valve.VR.InteractionSystem.Sample
{
    public class BuggyController : MonoBehaviour
    {
        ...
        public SteamVR_Action_Boolean actionFire = SteamVR_Input.GetAction<SteamVR_Action_Boolean>("buggy", "Fire");
        ...
        private void Update()
        {
            ...
            if (interactable.attachedToHand)
            {
                ...
                b_fire = actionFire.GetState(hand);
            ...
            buttonFire.localScale = new Vector3(1, 1, b_fire ? 0.4f : 1.0f);
